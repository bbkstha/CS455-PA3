...
public class Driver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (jobChoice.equals("1")) {
            ...
            job1.setCombinerClass(Job1Combiner1.class);
            ...
            FileOutputFormat.setOutputPath(job1, new Path(args[1] + "/job12_tmp"));
            ...
            FileInputFormat.addInputPath(job1_1, new Path(args[1] + "/job12_tmp"));
            FileOutputFormat.setOutputPath(job1_1, new Path(args[1] + "/Job12"));
            System.exit(job1_1.waitForCompletion(true) ? 0 : 1);

        }

        if(jobChoice.equals("3")) {
        ...
        //job1.setSortComparatorClass(Job1Comparator.class);
        job3.setNumReduceTasks(25);
        job3.setCombinerClass(Job3Reducer1.class);
        ...
        FileOutputFormat.setOutputPath(job3, new Path(args[1] + "/job3_tmp"));
        job3.waitForCompletion(true);

        DistributedCache.addCacheFile(new URI("/data/supplementary/airports.csv"), conf);
        //DistributedCache.addCacheFile(new URI(args[1]+"/airports.csv"), conf);
        ...
        FileInputFormat.addInputPath(job3_1, new Path(args[1] + "/job3_tmp"));
        FileOutputFormat.setOutputPath(job3_1, new Path(args[1] + "/Job3"));
        System.exit(job3_1.waitForCompletion(true) ? 0 : 1);
    }

        if(jobChoice.equals("4")) {
            ...
            //job1.setSortComparatorClass(Job1Comparator.class);
            job4.setCombinerClass(Job4Combiner1.class);
            job4.setReducerClass(Job4Reducer1.class);
            job4.setNumReduceTasks(25);
            //job4.setMapOutputKeyClass(IntWritable.class);
            //job4.setMapOutputValueClass(Text.class);
            job4.setOutputKeyClass(Text.class);
            job4.setOutputValueClass(Text.class);
            FileInputFormat.addInputPath(job4, new Path(args[0]));
            FileOutputFormat.setOutputPath(job4, new Path(args[1] + "/job4_tmp"));
            job4.waitForCompletion(true);

            DistributedCache.addCacheFile(new URI("/data/supplementary/carriers.csv"), conf);
            ...
            FileInputFormat.addInputPath(job4_1, new Path(args[1] + "/job4_tmp"));
            FileOutputFormat.setOutputPath(job4_1, new Path(args[1] + "/Job4"));
            System.exit(job4_1.waitForCompletion(true)?0:1);
        }

        if(jobChoice.equals("5")) {


            /*******Driver code of Job5********/

            DistributedCache.addCacheFile(new URI("/data/supplementary/plane-data.csv"), conf);
            ...
            FileOutputFormat.setOutputPath(job5, new Path(args[1] + "/job5_tmp"));
            ...
            FileInputFormat.addInputPath(job5_1, new Path(args[1] + "/job5_tmp"));
            FileOutputFormat.setOutputPath(job5_1, new Path(args[1] + "/Job5"));
            System.exit(job5_1.waitForCompletion(true) ? 0 : 1);
        }

        if(jobChoice.equals("6")) {
            ...
            job6.setNumReduceTasks(25);
            job6.setMapperClass(Job6Mapper1.class);
            //job1.setSortComparatorClass(Job1Comparator.class);
            job6.setCombinerClass(Job6Combiner1.class);
            ...
            FileOutputFormat.setOutputPath(job6, new Path(args[1] + "/job6_tmp"));
...
//        String uriWithLink = filePath.toUri().toString();
            ...
            FileInputFormat.addInputPath(job6_1, new Path(args[1] + "/job6_tmp"));
            FileOutputFormat.setOutputPath(job6_1, new Path(args[1] + "/Job6"));
            System.exit(job6_1.waitForCompletion(true) ? 0 : 1);
        }


        if(jobChoice.equals("7")) {
            ...
            job7.setNumReduceTasks(25);
            job7.setMapperClass(Job7Mapper1.class);
            //job1.setSortComparatorClass(Job1Comparator.class);
            job7.setCombinerClass(Job7Reducer1.class);
            ...
            FileOutputFormat.setOutputPath(job7, new Path(args[1] + "/job7_tmp"));
...
//        String uriWithLink = filePath.toUri().toString();
            ...
            FileInputFormat.addInputPath(job7_1, new Path(args[1] + "/job7_tmp"));
            FileOutputFormat.setOutputPath(job7_1, new Path(args[1] + "/Job7"));
